 ...
 //const { getPath } = require('./BOOTSTRAP/PATH');
 
 //const { get_savedFilters } = require('./services/writeServices');
...
function set_activeFilters( value){ activeFilters = value;}
 ...
 function set_selectedKeys( value){ 

  shared_state.selectedKeys = value;
  selectedKeys = value;
}
